      ...
      <div class="video-container">
        <div class="title-container">
          ...
          <div class="description">
            <div class="inner">DIESEL PARTICULATE FILTER CLEANING EQUIPMENT
            </div>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-7">
            ...
            <p class="lead">FSX manufactures and distributes diesel particulate filter cleaning equipment used in the trucking, transit, off-road, railroad and power generation. Utilizing FSX DPF cleaners assures that the user will get the maximum life possible between
            ...
            <header id="myCarousel" class="carousel slide">
              ...
              <div class="carousel-inner">
                <div class="item active">
                  ...
                  <div class="fill">
                    <a href=""><img src="img/special_offer_fsx.png" class="img-responsive center-block" alt="Responsive image"></a>
                  </div>
                </div>
                <div class="item">
